...
public class DialogueList : MonoBehaviour, IEnhancedScrollerDelegate
{
    ...
    /// </summary>
    private SmallList<DialogueRoomData> _data;
    ...
    void Awake()
    {
        _data = new SmallList<DialogueRoomData>();
    }
    ...
    private void LoadLargeData()
    {
        ...
        for (var i = 0; i < 1000; i++)
            _data.Add(new DialogueRoomData() { someText = "Cell Data Index " + i.ToString() });
    ...
    public void AddDialogueRoomDatas(ref SmallList<DialogueRoomData> dialogueroomDatas)
    {
        _data = dialogueroomDatas;
    }

    public void AddDialogueRoomData(int ID, string strNick, bool bAvatarImage = false)
    {
    ...
    private void LoadSmallData()
    {
        ...
        _data.Add(new DialogueRoomData() { someText = "A" });
        _data.Add(new DialogueRoomData() { someText = "B" });
        _data.Add(new DialogueRoomData() { someText = "C" });
    ...
    public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
    {
        ...
        DialogueCellView cellView = scroller.GetCellView(cellViewPrefab) as DialogueCellView;
